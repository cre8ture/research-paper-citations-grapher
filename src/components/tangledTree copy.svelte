<script>
    ...
    import {wrapText} from '../support/tangleTreeHelpers.js'
    let data = [
    [{ id: "Machine Learning" }],
    [
      { id: "Using qauntization to create acyclic graphs that fold in on themselved to create new forms of generative AI.", parents: ["Machine Learning"] },
      { id: "Using diffusion models to develop code to create code", parents: ["Machine Learning"] }
    ],
    [
      { id: "Q3", parents: ["Using qauntization to create acyclic graphs that fold in on themselved to create new forms of generative AI."] },
      { id: "Q4", parents: ["Using qauntization to create acyclic graphs that fold in on themselved to create new forms of generative AI."] },
      { id: "F2", parents: ["Using qauntization to create acyclic graphs that fold in on themselved to create new forms of generative AI."] },
      { id: "F3", parents: ["Using qauntization to create acyclic graphs that fold in on themselved to create new forms of generative AI."] }
    ],
    [
      { id: "F4", parents: ["Using qauntization to create acyclic graphs that fold in on themselved to create new forms of generative AI.", "Q3"] },
      { id: "F5", parents: ["Q3"] },
      { id: "F6", parents: ["Q3"] },
      { id: "F7", parents: ["Q3"] },
      { id: "F8", parents: ["Q4"] },
    ...
    chartOptions)
      ...
      tangleLayout.nodes.forEach((node) => {
        ...
        // Text for the node
const nodeText = svg.append("text")
...
wrapText(nodeText, 200); // 50 is the max width; adjust as needed
